...
class WWW::HorizonsEphemerisSystem {
    ...
    method observer-ephemeris(*%params, |c --> HorizonsResponse:D) {
        self!query-for('OBSERVER', |%params, |c)
    }

    method vectors-ephemeris(*%params, |c --> HorizonsResponse:D) {
        self!query-for('VECTORS', |%params, |c)
    }

    method elements-ephemeris(*%params, |c --> HorizonsResponse:D) {
        self!query-for('ELEMENTS', |%params, |c)
    }

    method approach-table(*%params, |c --> HorizonsResponse:D) {
        self!query-for('APPROACH', |%params, |c)
    }

    method spk-file(*%params, |c --> HorizonsResponse:D) {
        self!query-for('SPK', |%params, |c)
    }
    ...
    method !query-for(Str:D $ephem-type, *%params, |c --> HorizonsResponse:D) {
        die X::WWW::HorizonsEphemerisSystem.new(
        ...
        self.query(|%call-params, |c);
    }
}

our sub horizons-client(|c --> WWW::HorizonsEphemerisSystem:D) is export {
    WWW::HorizonsEphemerisSystem.new(|c)
}
